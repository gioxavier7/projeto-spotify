    ...
    try {
        if(String(contentType).toLowerCase() == 'application/json')
        {
            if(
                ...
                playlist.duracao == undefined || playlist.duracao == '' || playlist.duracao == null || playlist.duracao.length > 45 ||
                playlist.descricao == undefined || playlist.descricao == '' || playlist.descricao == null || playlist.descricao.length > 75 ||
    ...
    try {
        ...
        if(resultPlaylist != false || typeof(resultPlaylist) == 'object')
        {
            ...
            if(resultPlaylist.length > 0){
                ...
                //adiciona o novo array de filmes no json o
            }else{
